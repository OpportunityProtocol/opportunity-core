...
contract MilestoneRelationshipManager is IRelationshipManager, IMilestoneRelationshipManager {
    mapping(uint256 => RelationshipLibrary.Milestone[]) public relationshipIDToMilestones;
    ...
    override
    {
        ...
        relationshipIDToMilestones[_relationshipID] = milestones;
